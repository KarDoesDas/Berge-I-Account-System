package Berge_I.web.sb.controller;

import Berge_I.logic.flow.CreateAccountTypeFlow;
...
import Berge_I.domain.service.GeneralResponse;
...
public class AccountTypeController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Account created successfully", response = GeneralResponse.class),
            @ApiResponse(code = 400, message = "Bad Request", response = GeneralResponse.class),
            @ApiResponse(code = 500, message = "Internal Server Error", response = GeneralResponse.class)})
    ...
    public ResponseEntity<GeneralResponse<AccountTypeDto>> updateAccountType(
            ...
            @ApiParam(value = "The optional date with which to update the CreationDate in ISO date format (YYYY-MM-DD)\r\nif",
                    name = "newAccountTypename")
